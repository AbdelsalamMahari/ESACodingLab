        ...
        <div class="right-part">
            <div class="text-cont">
                <p>At our library store, we believe in the transformative power of books and the importance
                    ...
                    Every time you rent a book from our library store, <b>a portion of the rental fee will be
                        automatically
    ...
    <section class="description1">
        <div class="left-part1">
            <div class="text-cont1">
                <p>By choosing to rent books from our library, you not only engage in a delightful reading experience
