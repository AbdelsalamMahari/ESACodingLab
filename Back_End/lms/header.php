...
<body>
    <header>
        ...
        <li>
            <a class="dropdown-item" href="#"><i class="fa-solid fa-user"></i><?php echo $email; ?></a>
        </li>
        <li>
    ...
    <?php } ?>
                ...
                <?php if(isset($_SESSION["email"])) { ?>
                    <a href="http://localhost/lms/favorite.php"><i class="fa-solid fa-heart"></i></a>
                    <a href="http://localhost/lms/cart.php"><i class="fa-solid fa-cart-shopping"></i></a>
                <?php } else { ?>
                    <a href="http://localhost/lms/login.php"><i class="fa-solid fa-heart"></i></a>
                    <a href="http://localhost/lms/login.php"><i class="fa-solid fa-cart-shopping"></i></a>
                <?php } ?>
