                ...
                <div class="row">
                    <div class="col-md-6 col-xl-6">
                        ...
                        <div class="input-group-append">
                            <button type="button" onclick="getSearchMood('searchName')" id="searchName" class="btn btn-success" style="background-color: #1886a9; border-color: #fff;">By Name</button>
                            <button type="button" onclick="getSearchMood('searchCategory')" id="searchCategory" class="btn btn-success" style="background-color: #1886a9; border-color: #fff;">By Category</button>
                        </div>
                        </div>
                    </div>
                    </div>
