                     ...
                     <div class="col-xl-12 ">
                        <div class="card mg-b-20">
                           ...
                           <div class="collapse show" id="transactionHistory">
                              ...
                              <?php
                  $query = "SELECT * FROM payment LIMIT 6";
...
$quey = "SELECT db_email, SUM(totalAmount) AS totalAmount FROM payment GROUP BY db_email ORDER BY totalAmount DESC LIMIT 6";
            ...
            <footer class="page-footer">
               <div class="pd-t-4 pd-b-0 pd-x-20">
                  <div class="tx-10 tx-uppercase">
                     <p class="pd-y-10 mb-0"> All copyrights reservet @booklibrary    </p>
                  </div>
               </div>
            </footer>
            <!--/ Page Footer End -->		
