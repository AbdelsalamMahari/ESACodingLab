...
if ($result->num_rows > 0) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'bookstore979@gmail.com';
        $mail->Password = 'ykzp lmai jwzn vuup';
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
        $mail->Port = 465;

        $mail->setFrom('bookstore979@gmail.com', 'bookStore'); 
        $mail->addAddress($email); 
        $mail->addReplyTo('bookstore979@gmail.com', 'bookStore'); 
